...
impl Engine {
    ...
    /// let mut engine = Engine::new();
    ///
    /// engine.register_fn_with_comments("add", &["add two numbers together"], add);
    ///
    /// assert_eq!(engine.eval::<i64>("add(40, 2)")?, 42);
    ///
    /// // You can also register a closure.
    /// engine.register_fn_with_comments("sub", &["add two numbers together"], |x: i64, y: i64| x - y );
    ///
    /// assert_eq!(engine.eval::<i64>("sub(44, 2)")?, 42);
    /// # Ok(())
    /// # }
    ...
    #[cfg(feature = "metadata")]
    #[inline]
    pub fn register_fn_with_comments<
        A: 'static,
        const N: usize,
        const X: bool,
        R: Variant + Clone,
    ...
    >(
        ...
        let reg = {
            ...
            reg.with_comments(comments)
                .with_params_info(param_type_names)
        };
    ...
    #[cfg(not(feature = "no_object"))]
    #[inline(always)]
    pub fn register_get_with_comments<
        T: Variant + Clone,
        const X: bool,
        R: Variant + Clone,
        const F: bool,
    >(
        ...
        self.register_fn_with_comments(crate::engine::make_getter(name.as_ref()), comments, get_fn)
    }
    ...
    #[cfg(not(feature = "no_object"))]
    #[inline(always)]
    pub fn register_set_with_comments<
        T: Variant + Clone,
        const X: bool,
        R: Variant + Clone,
        const F: bool,
    >(
        ...
        self.register_fn_with_comments(crate::engine::make_setter(name.as_ref()), comments, set_fn)
    }
    ...
    #[cfg(not(feature = "no_object"))]
    #[inline(always)]
    pub fn register_get_set_with_comments<
        T: Variant + Clone,
        const X1: bool,
        const X2: bool,
        R: Variant + Clone,
    ...
    >(
        ...
        self.register_get_with_comments(&name, comments, get_fn)
    ...
    #[cfg(any(not(feature = "no_index"), not(feature = "no_object")))]
    #[inline(always)]
    pub fn register_indexer_get_with_comments<
        T: Variant + Clone,
        IDX: Variant + Clone,
        const X: bool,
        R: Variant + Clone,
    ...
    >(
        ...
        self.register_fn_with_comments(crate::engine::FN_IDX_GET, comments, get_fn)
    }
    ...
    #[cfg(any(not(feature = "no_index"), not(feature = "no_object")))]
    #[inline(always)]
    pub fn register_indexer_set_with_comments<
        T: Variant + Clone,
        IDX: Variant + Clone,
        const X: bool,
        R: Variant + Clone,
    ...
    >(
        ...
        self.register_fn_with_comments(crate::engine::FN_IDX_SET, comments, set_fn)
    }
    ...
    #[cfg(any(not(feature = "no_index"), not(feature = "no_object")))]
    #[inline(always)]
    pub fn register_indexer_get_set_with_comments<
        T: Variant + Clone,
        IDX: Variant + Clone,
        const X1: bool,
        const X2: bool,
    ...
    >(
        ...
        self.register_indexer_get_with_comments(comments, get_fn)
